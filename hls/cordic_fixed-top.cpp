...
{	
	...
	fp=fopen("out.dat","w");
	for(int i=10;i<NUM_DEGREE;i=i+10) {
			radian = i*M_PI/180;
			cordic(radian, s, c);
			...
			printf("design: degree=%d, radian=%f, cos=%f, sin=%f\n", i, (double)radian, (double)c, (double)s);
			printf("golden: degree=%d, radian=%f, cos=%f, sin=%f\n", i, (double)radian, (double)zc, (double)zs);
			//fprintf(fp, "design: degree=%d, radian=%f, cos=%f, sin=%f\n", i, (double)radian, (double)c, (double)s);
			//fprintf(fp, "golden: degree=%d, radian=%f, cos=%f, sin=%f\n", i, (double)radian, (double)zc, (double)zs);
	}
